                            ...
                            <div className="portfolio-comments">
                                <div className={"comments"}>
                                    <div className={"portfolio-user-comment"}>
                                        ...
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, culpa cumque
                                            doloremque eaque enim error eveniet facere, ipsa nam nostrum numquam optio quam quia
                                            rem repudiandae sed tempora. Cum deserunt mollitia nam nulla pariatur voluptates.
                                        </p>
                                    </div>
